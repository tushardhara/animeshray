...
<div class="thb-content-share">
	...
	<ul>
		...
		<li>
			<a data-type="thb-pinterest" href="//pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php echo urlencode( $src[0] ); ?>&amp;description=<?php echo urlencode( $title ); ?>" target="_blank" class="product_share_pinterest">
				<span>
		...
		<li>
			<?php
				...
				$body = strip_tags(apply_filters( 'woocommerce_short_description', $post->post_excerpt ) ) . ' ' . $permalink;
			?>
			<a data-type="thb-email" href="mailto:enteryour@addresshere.com?subject=<?php echo rawurlencode( $title ); ?>&amp;body=<?php echo rawurlencode( $body ); ?>" class="product_share_email">
				<span>
