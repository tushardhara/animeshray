			...
			$(document).ready(function() {
				...
				setTimeout( function() {
					BackgroundCheck.init({
						targets: '.rsArrow .rsArrowIcn',
						images: '.rsSlide img'
					});

					$(".thb-product-slideshow").data( "royalSlider" ).ev.on('rsAfterSlideChange', function(e, slideObject) {
						BackgroundCheck.set( "images", ".thb-product-slideshow .rsActiveSlide img" );
