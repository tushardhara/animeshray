...
<div class="thb-photogallery">
	<?php if ( count( $slides ) > 0 ) : ?>
		...
		?>
		<ul <?php if ( ! empty ( $thb_grid_layout_id ) ) : ?>id="<?php $thb_grid_layout_id; ?>"<?php endif; ?> class="thb-photogallery-container thb-images-container <?php thb_grid_layout_class( $columns, $gutter, $height ); ?>" <?php thb_data_attributes( $data_attrs ); ?>>
